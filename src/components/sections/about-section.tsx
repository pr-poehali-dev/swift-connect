      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              { value: "5K+", label: "Читателей", sublabel: "Подписчиков на канале", direction: "right" },
              { value: "200+", label: "Статей", sublabel: "Материалов и гайдов", direction: "left" },
              { value: "Daily", label: "Обновления", sublabel: "Новости каждый день", direction: "right" },
            ].map((stat, i) => {
